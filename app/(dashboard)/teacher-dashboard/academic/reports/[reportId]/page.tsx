...
import { AcademicReportPageClient } from "../../../academic-reports/academic-report-page-client";

export const metadata = { title: "Academic report" };

export default async function AcademicHubReportDetailPage(props: {
  ...
  const [{ data: clsRow }, { data: schRow }, { data: profileRow }] =
    await Promise.all([
      supabase
        .from("classes")
        .select("name")
