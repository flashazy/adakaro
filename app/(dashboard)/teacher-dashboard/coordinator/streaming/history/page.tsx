...
import { StreamingHistoryClient } from "./history-client";

export const dynamic = "force-dynamic";

export const metadata = {
  title: "Streaming History — Coordinator",
};
...
export default async function StreamingHistoryPage({
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 px-0 pb-8 sm:px-1">
      <StreamingHistoryClient initialAcademicYear={academicYear} />
    </div>
  );
}
