...
const NAV_LINKS = [
  ...
  },
  {
    ...
    desc: "Control parent report card access by fee payment.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    title: "Enrollment Desk Users",
    desc: "Temporary helpers for enrollment intake.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    desc: "Approve Enrollment Desk student submissions.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
